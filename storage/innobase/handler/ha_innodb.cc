...
static MYSQL_SYSVAR_LONGLONG(flash_read_cache_size, innobase_flash_read_cache_size,
  PLUGIN_VAR_READONLY,
  "The size of the flash cahce InnoDB uses to cache data and indexes of its tables.",
...
static MYSQL_SYSVAR_ULONG(flash_cache_do_full_io_pct, srv_flash_cache_do_full_io_pct,
  PLUGIN_VAR_READONLY,
  "Flash cache write cache percentage",
  NULL, NULL, 70L, 0, 90L, 0);

static MYSQL_SYSVAR_ULONG(flash_cache_migrate_pct, srv_flash_cache_migrate_pct,
  PLUGIN_VAR_READONLY,
  "Flash cache write cache percentage",
  NULL, NULL, 80L, 30L, 100L, 0);
