...
/** secondary buffer pool buffered writes */
typedef struct buffer_writes_struct buffer_writes_t;
/** secondary buffer pool migration queue */
typedef struct migration_queue_struct migration_queue_t;
