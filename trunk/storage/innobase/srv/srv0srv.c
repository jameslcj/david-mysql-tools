...
/* page cleaner thread */
UNIV_INTERN my_bool	srv_enable_page_cleaner_thread;
...
loop:
	...
	for (i = 0; i < 10; i++) {
		...
		if ( !srv_enable_page_cleaner_thread ){
...
{
	return(srv_activity_count != old_activity_count);
}
